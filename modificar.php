				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="radio-inline">
							<input type="radio" id="hijos" name="hijos" value="SI" <?php if($row['hijos']=='SI') echo 'checked'; ?>> SI
						</label>
						
						<label class="radio-inline">
							<input type="radio" id="hijos" name="hijos" value="NO" <?php if($row['hijos']=='NO') echo 'checked'; ?>> NO
						</label>
					</div>
				</div>
